...
#########################################################
    ...
    np.savez(train_dir + f"train_ratio{args.down_ratio}.npz",target = hrtraind,data = lrtraind)
    ...
    # np.savez(fn + "_test.npz",hr_sample = hrtestd,lr_sample = lrtestd)
    np.savez(valid_dir + f"valid_ratio{args.down_ratio}.npz",target = hrvalid,data = lrvalid)
    ...
    np.savez(test_dir + f"test_ratio{args.down_ratio}_target.npz", **whole_hrmat)
    np.savez(test_dir + f"test_ratio{args.down_ratio}.npz", **whole_lrmat)
